...
BINARY_FUSED_ADD_GELU(__nv_bfloat16, fadd_gelu_bf16)
...
BINARY_FUSED_ADD_GELU(__half, fadd_gelu_f16)
...
BINARY_FUSED_ADD_GELU(float, fadd_gelu_f32)
BINARY_FUSED_ADD_GELU(double, fadd_gelu_f64)
